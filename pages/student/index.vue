...
<template>
  <section class="flex flex-col items-center justify-center h-screen">
    <UCard>
      ...
      <p>
        Please read each question carefully and select the best answer. Good
        luck!
      </p>
    </UCard>
    ...
    <UButton
      ...
      color="indigo"
      size="lg"
      :to="`/student/${userStore.user?.name}/question/${questionsData[0].slug}`"
    >
      Start Test
    </UButton>
  </section>
